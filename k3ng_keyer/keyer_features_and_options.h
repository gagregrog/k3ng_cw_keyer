...
#define EXTRA_BUTTONS                  // adds one more analog button beyond the command + memory buttons, for a custom action (see check_buttons() in k3ng_keyer.ino) - requires FEATURE_BUTTONS
